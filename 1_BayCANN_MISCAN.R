...
.libPaths(c("V:/UserData/057111/RlibCustom/4.2", "P:/R/R-4.2.1/library"))
setwd("C:/Users/057111/PycharmProjects/baycann_cisnet_crc")
reticulate::use_virtualenv("C:/Users/057111/PycharmProjects/baycann_cisnet_crc/baycannVenv")
# venv with Tensorflow installed

library(keras)
library(rstan)
library(reshape2, lib.loc = "P:/R/R-4.2.1/library")
library(tidyverse)
library(ggplot2, lib.loc = "P:/R/R-4.2.1/library")
library(doParallel)
...
BayCANN_version <- "MISCAN_v3.2_20240205_1322PST"
...
params_file      <- "data-raw/20240205_MISCANColon_LHS/SimulatedParameters_20240205_1322PST.csv"
...
outputs_file     <- "data-raw/20240205_MISCANColon_LHS/SimulatedTargets_20240205_1322PST.csv"
...
targets_file     <- "data-raw/20240205_MISCANColon_LHS/CurrentTargets_20240205_1322PST.csv"
