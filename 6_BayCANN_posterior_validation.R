...
###### Version 3.2 BayCANN MISCAN (05 Feb 2024)
data_outputs_miscan <- read.csv("validations/MISCAN_v3.2_20240205_1322PST/targets-input_baycann_20240205.csv")
data_outputs_miscan$index <- "Model"
true_target_miscan <- read.csv("data-raw/20240205_MISCANColon_LHS/CurrentTargets_20240205_1322PST.csv")
